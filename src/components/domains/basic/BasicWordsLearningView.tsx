...
interface BasicWordsLearningViewProps {
  onBackToSelection: () => void;
}

export function BasicWordsLearningView({ onBackToSelection }: BasicWordsLearningViewProps) {
  return (
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h3 className="font-bold text-gray-800">基本単語 기초 단어</h3>
              <p className="text-sm text-gray-600">일상 필수 일본어 단어</p>
            </div>
          </div>
        </div>
